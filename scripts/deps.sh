...
if [ $RESULT -gt 0]; then
  echo "Unzip was not found. Please install 'unzip' (usually installed using 'apt install unzip zip' on Debian-based distros)"
  exit 1
fi
...
if [ $RESULT -gt 0]; then
  echo "zip was not found. Please install 'zip' (usually installed using 'apt install unzip zip' on Debian-based distros)"
  exit 1
fi
